...
try{
    ...
    $st = $PDOconn->query("select * from sistemi_e_reti_router_esercizio_2");
...
<head>
    ...
    <title>Sistemi e reti esercizio 2</title>
</head>
<body>
...
<div id="main">
    ...
    <form action="../server/server_sistemi_e_reti_esercizio_2.php" method="POST" name="modulo">
