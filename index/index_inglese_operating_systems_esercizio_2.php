...
<div id="main">
    ...
    <div id="sideMenu">
        <ul>
            <li class="cap" >Operating Systems</li>
            <li> <a href="../index/index_inglese_operating_systems_esercizio_1.php">Esercizio 1</a></li>
            <li> <a href="../index/index_inglese_operating_systems_esercizio_2.php">Esercizio 2</a></li>
        </ul>
    </div>
