...
<div id="main">
    ...
    <div id="sideMenu">
        <ul>
            <li class="cap" >Illuminismo</li>
            <li> <a href="../index/index_italiano_illuminismo_esercizio_1.php">Esercizio 1</a></li>
        </ul>
    </div>

    <form action="../server/server_italiano_illuminismo_esercizio_1.php" method="POST" name="modulo">
